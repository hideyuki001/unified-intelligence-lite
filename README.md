...
- 🔄 Symbolic chain preservation with time-aware metaphor tracking (NEW)  
- 📉 Risk parity & correlation breakdown detection (NEW)  
...
| risk-parity.md | Risk parity & correlation breakdown evaluator | ✅ Uploaded |
| symbolic-cascade.md | Symbolic chain preservation & coherence evaluator | ✅ Uploaded |
...
| var-model.md | Multi-asset correlation analysis (VAR) | ✅ Uploaded |
| unified-output-template.md | Unified output format (Markdown + JSON) | ✅ Uploaded |
| quality-cascade.md | Unified scoring cascade (translation + symbolic + theory) | ✅ Uploaded |
...
### 🔹 Translation QA
/qa-translate "Original: 私は東京に行きました。 Translation: I went to Tokyo." --structural-verify --neural-alignment


### 🔹 Symbolic Reasoning
/poeticize "The market trembles like a wounded animal." --delta-S=0.7 --symbolic-palette


### 🔹 Symbolic Cascade (New)
/poeticize "The city breathes with iron lungs and neon veins." --symbolic-cascade


### 🔹 Economic Scenario Analysis
/scenario "Fed cuts 25bp, DXY+3%, BTC-5%" --synapse-mode --theory-bias --temporal-projection


### 🔹 Risk Parity Analysis (New)
...
| ✅ Symbolic Extraction | Metaphoric Text | Symbol Tags + ΔS + Symbolic Cascade |
| ✅ Economic Reasoning | Policy Scenario | IS-LM Score + FX/Macro Bias |
| ✅ Recursive QA | Model Output | CoT Chain Trace + Validity Judgement |
| ✅ Symbolic Cascade | Symbolic Chains | Preservation %, Cascade Depth, Coherence Score |
| ✅ Risk Parity | Portfolio Composition | Risk Contribution + Correlation Breakdown Score |
...
Poetic Technologists: for modeling metaphor chains and symbolic drift
...
✅ All planned modules (VAR, Output Templates, Quality Cascade) are now included in v3.0.
